    ...
    <div>
      ...
      >
        <div className="ui top header">
          ...
          <div className="content">Cart Items</div>
        </div>
          ...
          <div className="ui two column grid">
                      ...
                      <tr>
                        ...
                        <td className="right aligned">
                          <div class="ui left action input">
                            ...
                            <input type="text" value="10" style={{ maxWidth: 55 }} />
                ...
                <tfoot>
                  <tr>
                    ...
                    <th className="right aligned">
                      <i className="dollar sign icon"></i>123
                    </th>
                  </tr>
                </tfoot>
              </table>
            ...
            <div className="ui six wide middle aligned column">
              <div className="ui center aligned basic segment">
                <button className="ui large teal button">
                    <i className="shopping basket icon"></i> Cart Checkout
                </button>
                <br />
                <br />
                <button className="ui large basic button">
                    <i className="cart plus icon"></i> Continue Shopping
                </button>
              </div>
            </div>
          </div>
